#!/usr/bin/env python3
"""
奇门遁甲排盘 —— 薄封装，委托 qimen.py 全九宫排盘。

用法：
    py -3 qimen_pan.py 2026-07-04 06:00 --json

完整排盘请优先使用同目录 qimen.py（本脚本与其等价）。
"""
...
from qimen import build_qimen, format_output  # noqa: E402
...
def main() -> None:
    p = argparse.ArgumentParser(description="奇门遁甲全排盘（委托 qimen.py）")
